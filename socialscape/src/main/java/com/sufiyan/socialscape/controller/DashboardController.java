...
public class DashboardController {
    ...
    @FXML private VBox root; // This binds to fx:id="root" in dashboard.fxml
    ...
    public void handleAddPost() {
        ...
        try {
            formattedDate = LocalDate.parse(inputDate, DateTimeFormatter.ofPattern("dd/MM/yyyy"))
                    .format(DateTimeFormatter.ofPattern("yyyy/MM/dd"));
        } catch (Exception e) {
            lblStatus.setText("Invalid date format. Use dd/MM/yyyy");
            return;
        }
        ...
        if (editingPost != null) {
            ...
            editingPost.setDate(formattedDate);
            ...
            post.setMediaPath(selectedMediaPath);
